...
Sub.BackgroundTransparency=1 Sub.Text="LAUNCHER v1.0"Sub.TextColor3=Color3.fromRGB(150,150,180)
...
local Scripts={
    {Name="Murder Mystery 2",Desc="ESP, Aimbot, Fling, Fly, Chams, X-Ray",Icon="[M]",Color=Color3.fromRGB(255,80,80)},
    {Name="+1 Speed",Desc="Speed Boost, Fly, Anti-Kick",Icon="[S]",Color=Color3.fromRGB(80,180,255)},
    {Name="Fling Things",Desc="Throw Power, Range, Anti-Grab",Icon="[F]",Color=Color3.fromRGB(80,255,150)},
    {Name="Universal ESP",Desc="Works in all games",Icon="[U]",Color=Color3.fromRGB(255,200,50)},
    {Name="Universal Fly",Desc="Works in all games",Icon="[Y]",Color=Color3.fromRGB(200,100,255)},
}
