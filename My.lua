-- Syphixman MM2 v34 | Fixed Opening
...
M.Size=UDim2.new(0,400,0,450)
M.Position=UDim2.new(.5,-200,.5,-225)
...
CB.Position=UDim2.new(1,-30,0,8)
...
local function mkSlider(parent,name,y,min,max,def,set)
    pcall(function()
        ...
        sb.Position=UDim2.new(.38,0,0,13)
...
PlayerList.Size=UDim2.new(1,-8,0,350)
...
RefreshBtn.Position=UDim2.new(0,4,0,360)
...
mkBtn(WorldSF,"Teleport Map",47,function()
    pcall(function()
...
mkToggle(SettingsSF,"Phone Buttons",131,"ShowPhoneButtons")
